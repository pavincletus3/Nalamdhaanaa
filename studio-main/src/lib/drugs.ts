...
export const drugs: Drug[] = [
  ...
  },
  {
    ...
    alternatives: [
      ...
      { name: 'Ipratropium Bromide Inhaler', price: 350, availability: 'medium' },
    ],
    average_price: 250,
  },
  {
  ...
  },
  {
    ...
    category: 'Antibiotic',
    shortage_risk: 0.68,
    risk_factors: ['bacterial_resistance_concerns', 'production_line_contamination'],
    alternatives: [
  ...
  },
  {
    ...
    shortage_risk: 0.75,
    risk_factors: ['narrow_therapeutic_index', 'monitoring_requirements', 'single_api_supplier'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Thyroid',
    shortage_risk: 0.50,
    risk_factors: ['bioequivalence_issues', 'high_prevalence_of_thyroid_disorders'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Pain Relief',
    shortage_risk: 0.60,
    risk_factors: ['abuse_potential_leading_to_regulation', 'supply_disruptions'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Antibiotic',
    shortage_risk: 0.69,
    risk_factors: ['versatile_use_in_infections', 'raw_material_sourcing_from_single_region'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Diabetes',
    shortage_risk: 0.82,
    risk_factors: ['complex_manufacturing_process', 'cold_chain_logistics', 'high_global_demand'],
    alternatives: [
  ...
  },
  {
    ...
    alternatives: [
        { name: 'Amoxicillin-Clavulanate 625mg', price: 150, availability: 'high' },
  ...
  },
  {
    ...
    category: 'Neuropathic Pain',
    shortage_risk: 0.65,
    risk_factors: ['controlled_substance_regulations', 'api_manufacturing_complexity'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Anxiety',
    shortage_risk: 0.70,
    risk_factors: ['high_abuse_potential', 'strict_prescribing_guidelines', 'production_quotas'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Antifungal',
    shortage_risk: 0.45,
    risk_factors: ['single-dose_treatment_popularity', 'occasional_outbreaks_of_fungal_infections'],
    alternatives: [
  ...
  },
  {
    ...
    category: 'Antidepressant',
    shortage_risk: 0.63,
    risk_factors: ['dual-indication_use_pain_depression', 'patent_cliff_dynamics'],
    alternatives: [
  ...
  },
  {
    ...
    shortage_risk: 0.60,
    risk_factors: ['multiple_indications', 'sedative_properties_leading_to_off-label_use'],
    alternatives: [
